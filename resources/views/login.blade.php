                        ...
                        <div class="col-xl-5 col-lg-6 col-md-8 col-sm-11">
                            ...
                            <div class="card my-5">
                                <div class="card-body p-5 text-center">
                                    <div class="h3 font-weight-light mb-3">Login</div>
                                </div>
                                <div class="card-body p-5">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <label class="text-gray-600 small" for="emailExample">Masukkan Email</label>
                                        ...
                                        <!-- Form Group (password)-->
                                        <div class="form-group">
                                            <label class="text-gray-600 small" for="passwordExample">Masukkan Password</label>
